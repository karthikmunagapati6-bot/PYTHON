...
student = {"name": "karthik", "age": 21, "marks": 85.5}
print(student)
...
student.pop("age")
#pop() remove the specified key and its value 

print(student)

#popitem() remove the last inserted key-value pair
student = {"name" : "karthik", "age" : 22, "course" : "python"}
student.popitem
...
student.setdefauld("age", 21)

print(student)
student = {"name": "karthik", "age": 21}
